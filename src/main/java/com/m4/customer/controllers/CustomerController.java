...
public class CustomerController {
	...
	public ResponseEntity<Object> updateCustomer(@PathVariable("customerId") String customerId, @RequestBody Customer customer) {
		try {
			return ResponseHandler.buildResponseEntity(
	...
	public ResponseEntity<Object> deleteCustomert(@PathVariable("customerId") String customerId) {
		try {
